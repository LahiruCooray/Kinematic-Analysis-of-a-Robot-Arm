...
void setup() {
  ...
  servo1.attach(9);  // Pin for Servo 2
  servo2.attach(10); // Pin for Servo 3
  servo3.attach(11); // Pin for Servo 4
...
void loop() {
  ...
  int servo1Pos = mapToServoRange(theta2);
  int servo2Pos = mapToServoRange(theta3);
  int servo3Pos = mapToServoRange(theta4);

  // Move servos to calculated positions
  servo2.write(servo1Pos);
  servo3.write(servo2Pos);
  servo4.write(servo3Pos);
